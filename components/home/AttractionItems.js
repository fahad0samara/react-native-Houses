...
export default function AttractionItems({ navigation, ...props }) {
  return (
    <>
      {props.attractionData.map((attraction, index) => (
        <TouchableOpacity
          key={index}
          activeOpacity={1}
        ...
        >
          ...
          >
            ...
            <AttractionInfo name={attraction.name} rating={attraction.rating} />
          </View>
        </TouchableOpacity>
      ))}
    </>
